...
public class UserBookControllerReactive {
    ...
    @Autowired
    public UserBookControllerReactive(UsersBooksRepositoryJPA usersBooksRepositoryJPA, UsersRepositoryJPA usersRepositoryJPA, BooksRepositoryJPA booksRepositoryJPA) {
